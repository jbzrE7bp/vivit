...
`plot_eigspace_vivit_vs_fb.py` for all configurations. 
"""
...
VERBOSE = True
PLOT_SUBDIR = os.path.join(PLOT_OUTPUT, "eigspace_vivit_vs_fb")
...
if __name__ == "__main__":
    ...
    for config in CONFIGURATIONS:
        ...
        cmd_str = rf"python ./plot_eigspace_vivit_vs_fb.py --config_str {config_str}"
