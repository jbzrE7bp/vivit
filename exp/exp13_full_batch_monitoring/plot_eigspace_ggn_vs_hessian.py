...
import numpy as np
import torch
from config import CONFIGURATIONS, PLOT_OUTPUT
from matplotlib import pyplot as plt
from plot_shared import get_config_title, get_xticks_labels
...
def plot_2(config, plot_data, fig_path):
    ...
    G_label = "GGN"
    H_label = "Hessian"
    for decimal_cp, G_ev, H_ev in zip(config["decimal_checkpoints"], G_evals, H_evals):
