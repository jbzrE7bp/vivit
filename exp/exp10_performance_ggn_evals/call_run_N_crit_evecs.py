"""Determine critical batch size for GGN eigen-pair computations.
...
from run_N_crit_evecs import __name__ as SCRIPT
...
DATA_DIR = os.path.join(HERE_DIR, "results", "N_crit", "evecs")
SCRIPT = f"{SCRIPT}.py"
