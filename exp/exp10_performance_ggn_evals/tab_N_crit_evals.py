"""Create LaTeX tables of critical batch sizes for eigenvalue computation."""

from os import makedirs, path
from typing import Dict

from call_run_N_crit_evals import N_max, configurations, get_output_file
...
FIG_DIR = path.join(HEREDIR, "fig", "N_crit", "evals")
